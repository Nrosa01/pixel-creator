...
<template>
    <dialog ref="modal" @close="onModalClose"
        ...
        <div ref="modalInner" class="w-[90vmin] lg:max-h-[90vmin] max-h-[90vh] flex flex-col">
            <form method="dialog">
                <button class="w-full bg-slate-200 border-2 border-black  hover:bg-slate-300 hover:scale-[1.01]  font-semibold py-1 px-2 rounded sm:grow-0 grow mt-4"><i class="ph-duotone ph-x-circle"></i>Close</button>
            </form>
            ...
            <form method="dialog">
                <button class="w-full bg-slate-200 border-2 border-black  hover:bg-slate-300 hover:scale-[1.01]  font-semibold py-1 px-2 rounded sm:grow-0 grow mb-4"><i class="ph-duotone ph-x-circle"></i>Close</button>
            </form>
        </div>
    </dialog>
</template>